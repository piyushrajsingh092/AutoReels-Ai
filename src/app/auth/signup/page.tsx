        ...
        <div className="flex min-h-screen items-center justify-center" style={{ minHeight: '100vh', display: 'flex' }}>
            <div className="card" style={{ width: '100%', maxWidth: '400px', padding: '2.5rem' }}>
                <div className="text-center" style={{ marginBottom: '2rem' }}>
                    ...
                    <p className="text-sm text-muted" style={{ marginTop: '0.5rem' }}>Start creating AI videos today</p>
                </div>

                <form className="flex-col flex gap-4" onSubmit={handleSignup}>
                ...
                <div className="text-center text-sm" style={{ marginTop: '1.5rem' }}>
                    <p className="text-muted">
                        ...
                        <Link href="/auth/login" style={{ color: 'var(--primary)', fontWeights: 600 }}>
                            Sign in
                        </Link>
                    </p>
                </div>
